...
public class Member implements Serializable{
	...
	Member (String currentLine) {
		...
		this.setZip(getStringAtIndex(currentLine, indexes[7], Math.min(indexes[8], currentLine.length())));
		this.setCity(getStringAtIndex(currentLine, indexes[5], indexes[6]));
		this.setIdNumber(getStringAtIndex(currentLine, indexes[6], indexes[7]));
	}
